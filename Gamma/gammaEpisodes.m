% Detects slow and fast gamma in the EEG. Code from Laura Colgin.
% Edited by Raymond Skjerpeng, 2010.
% EEG1      First EEG signal that are used for the detection
% EEG2      Simutanously recorded EEG
% f1        Lower frequency border (25 = slow gamma, 65 = fast gamma)
% f2        Higher frequency border ( 55 = slow gamma, 140 = fast gamma)
% Fs        Sampling frequency for the EEG signals
function [peak_ind_unique, non_overlap_peak_ind_unique, start2, stop2, non_overlap_gamma_windows_EEG1, non_overlap_gamma_windows_EEG2] = gammaEpisodes(EEG, EEG2, f1, f2, Fs)
